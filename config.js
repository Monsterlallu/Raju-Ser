...
module.exports = {
    ...
    PHONE: process.env.NUMBER === undefined ? '918594015079' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ? 'Amruser' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By RAJU_SER' : process.env.ALL_CAPTION,
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://telegra.ph/file/1986d89402b68b4f4aeca.jpg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'RAJU SER' : process.env.LOGO_NAME,
    CODE: process.env.C_CODE === undefined ? '91' : process.env.C_CODE,
    MENTION: process.env.TAG_REPLY === undefined ? '918594015079@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ RAJU SER ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    RAJU_SER: process.env.ALIVE_BUTTON === undefined ? 'Sed/Happy' : process.env.ALIVE_BUTTON,   
    ...
    BOTCREATOR: "afnanplk",
    MAHN: "918594015079,0",
    SUPPORT: "918594015079-1635775355",
